...
export class Raspisanie extends Component {
  ...
  componentDidMount() {
    Axios.get("http://localhost:3000/monday22").then((response) => {
      this.setState({
        monday: response.data,
        list: [...this.state.list, true],
      });
    });
    Axios.get("http://localhost:3000/tuesday22").then((response) => {
      this.setState({
        tuesday: response.data,
        list: [...this.state.list, true],
      });
    });
    Axios.get("http://localhost:3000/wednesday22").then((response) => {
      this.setState({
        wednesday: response.data,
        list: [...this.state.list, true],
      });
    });
    Axios.get("http://localhost:3000/thursday22").then((response) => {
      this.setState({
        thursday: response.data,
        list: [...this.state.list, true],
      });
    });
    Axios.get("http://localhost:3000/friday22").then((response) => {
      this.setState({
        friday: response.data,
        list: [...this.state.list, true],
      });
    });
    Axios.get("http://localhost:3000/saturday22").then((response) => {
